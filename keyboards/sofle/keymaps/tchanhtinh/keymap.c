...
#define LAYOUT_VIA( \
    ...
    L10, L11, L12, L13, L14, L15, L16, R09, R10, R11, R12, R13, R14, R15,  \
    L20, L21, L22, L23, L24, L25, L26, R19, R20, R21, R22, R23, R24, R25,  \
...
[_QWERTY] = LAYOUT_VIA(
  ...
  KC_TAB,   KC_Q,   KC_W,    KC_E,    KC_R,    KC_T, KC_LEFT,       KC_UP, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,  KC_HOME_END,
  KC_LSHIFT,   KC_A,   KC_S,    KC_D,    KC_F,    KC_G, KC_RIGHT,      KC_DOWN, KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN,  KC_ENT,
  KC_LCTRL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_GAMING,     KC_QWERTY,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_BSLS,
                 KC_LALT,KC_LALT,KC_LALT, KC_LGUI, KC_SPC,      KC_LAYER, KC_LBRC, KC_RBRC, KC_MINS, KC_EQL
),
...
//                  KC_LGUI,KC_LALT,KC_LALT, KC_LCTRL, KC_SPC,      KC_ENT,  KC_LBRC, KC_RBRC, KC_MINS, KC_EQL
// ),
...
[_LOWER] = LAYOUT(
  ...
  _______, XXXXXXX,   KC_UP, XXXXXXX,   RESET, XXXXXXX,                       KC_F10, KC_F11, KC_F12,  KC_LBRC, KC_LBRC,  KC_RBRC,
  _______, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, XXXXXXX,                       KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_RBRC, XXXXXXX,
...
static void print_status_narrow(void) {
    ...
    oled_write("TO", false);
    oled_set_cursor(0, 1);
    oled_write("CHANH", false);
    oled_set_cursor(0, 2);
    oled_write("TINH", false);
    oled_set_cursor(0, 4);
...
// void encoder_action(bool clockwise, int cw, int ccw) {
//     clockwise ? tap_code(cw) : tap_code(ccw);
// }

// bool encoder_update_user(uint8_t index, bool clockwise) {
//     index == 0 ? encoder_action(clockwise, KC_LEFT, KC_RIGHT) : encoder_action(clockwise, KC_UP, KC_DOWN);
//     return true;
// }
// #endif